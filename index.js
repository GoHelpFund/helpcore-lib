...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of helpcore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of helpcore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._helpcore);
global._helpcore = bitcore.version;
