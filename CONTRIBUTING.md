# Contributing to helpcore-lib

We're working hard to make *helpcore-lib* the most powerful JavaScript library for working with Help. Our goal is to have *helpcore-lib* be a library that can be used by anyone interested in Help, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://gohelpfund.com (Official Website)
...
These are some global design goals in helpcore-lib that any change must adhere.
...
When possible, helpcore-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of helpcore-lib methods. For example, calling `JSON.stringify` on an helpcore-lib object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'helpcore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the helpcore object.

DO:
```javascript
var helpcore = require('../');
var PublicKey = helpcore.PublicKey;
```
DON'T:
```javascript
...
```sh
git remote add gohelpfund git@github.com:gohelpfund/helpcore-lib.git
git pull --rebase gohelpfund master
```
...
```
Finally go to [github.com/gohelpfund/helpcore-lib](https://github.com/gohelpfund/helpcore-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of helpcore-lib.

If you have any questions feel free to post them to
[github.com/gohelpfund/helpcore-lib/issues](https://github.com/gohelpfund/helpcore-lib/issues).
